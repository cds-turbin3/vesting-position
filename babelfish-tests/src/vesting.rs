...
//! the two agree. It runs over a [`CampaignView`] (the on-chain Campaign,
//! decoded from frood's `Value`) and returns `None` on arithmetic overflow.

use crate::world::CampaignView;
