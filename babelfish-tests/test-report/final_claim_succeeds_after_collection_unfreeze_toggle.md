...
**Source:** [`tests/freeze.rs` L323](https://github.com/cds-turbin3/vesting-position/blob/7c9fb3a609fc786de731fb5d2ea82919f4974b08/babelfish-tests/tests/freeze.rs#L323)
...
| T3 | 9,000,000,000,000 | -1,000,000,000,000 | 0 |  | 1,000,000,000,000 | +1,000,000,000,000 | Claim (day 31) |
...
xychart-beta
    x-axis ["d0", "d1", "d1", "d31"]
    line [10000000000000, 10000000000000, 10000000000000, 9000000000000]
    line [0, 0, 0, 0]
    line [0, 0, 0, 1000000000000]
```
...
Creator (89714cu)
└─ VestingPositions::Initialize ✓ 89714cu
...
└─ VestingPositions::Claim ✓ 161052cu
   ...
   │  └─ token::initializeAccount3 ✓ 235cu
   ├─ system::createAccount ✓
   └─ mplCoreProgram::CreateV2 ✓ 25757cu
      ├─ system::createAccount ✓
      ├─ system::transferSol ✓
      ├─ system::transferSol ✓
      └─ system::transferSol ✓
...
Alice (78218cu)
└─ VestingPositions::Claim ✓ 78218cu
   ├─ mplCoreProgram::UpdatePlugin ✓ 22029cu
   │  └─ system::transferSol ✓
   └─ token::transferChecked ✓ 105cu
```
