...
**Source:** [`tests/vesting_schedule.rs` L48](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/vesting_schedule.rs#L48)
...
xychart-beta
    x-axis ["d0", "d2"]
    line [10000000000000, 9900000000000]
    line [0, 0]
```
...
*🟠 Vault balance (-100B) · 🔵 Creator balance (0)*
