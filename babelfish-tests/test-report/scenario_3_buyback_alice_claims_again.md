...
**Source:** [`tests/claim.rs` L94](https://github.com/cds-turbin3/vesting-position/blob/7172eb8fb4ae69b1e7af671b76095a6112c41e68/babelfish-tests/tests/claim.rs#L94)
...
*series: Vault balance (blue), Creator balance (orange), Alice balance (teal), Bob balance (gold)*
