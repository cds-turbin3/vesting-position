# cancel_campaign_fails_after_first_claim

**Source:** [`tests/clawback.rs` L322](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/clawback.rs#L322)
...
| T2 | 10,000,000,000,000 |  | 0 |  | 0 |  | CancelCampaign (day 1) |
...
*🟠 Vault balance (0) · 🔵 Creator balance (0) · 🟢 Alice balance (0)*
...
### T2: CancelCampaign (day 1)

| observation | before | after |
| --- | --- | --- |
| Alice balance | — | 0 |

- [x] refused: CampaignHasPositions — InstructionError(0, Custom(6024))
...
Creator (21233cu)
└─ VestingPositions::CancelCampaign ✗ 21233cu
```
