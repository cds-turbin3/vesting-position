...
**Source:** [`tests/freeze.rs` L219](https://github.com/cds-turbin3/vesting-position/blob/932c23856044d9b06abefcbda648838176349fe4/babelfish-tests/tests/freeze.rs#L219)
...
| T3 | 9,000,000,000,000 |  | 0 |  | 1,000,000,000,000 |  | ExcludeAsset (day 31) |
...
Creator (53444cu)
└─ VestingPositions::ExcludeAsset ✗ 53444cu
```
