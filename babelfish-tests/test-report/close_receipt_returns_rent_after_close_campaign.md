...
**Source:** [`tests/clawback.rs` L364](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/clawback.rs#L364)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| T0 | 1,000,000,000,000 | +1,000,000,000,000 | 0 |  | — |  | Initialize (day 0) |
| T1 | 1,000,000,000,000 |  | 0 |  | — |  | FirstClaim (day 1) |
...
xychart-beta
    x-axis ["d0", "d1", "d31", "d31", "d31"]
    line [1000000000000, 1000000000000, 1000000000000, 1000000000000, 1000000000000]
    line [0, 0, 1000000000000, 1000000000000, 1000000000000]
```
...
flowchart LR
    ...
    classDef signer fill:#d5e8d4,stroke:#82b366,color:#17202a;
    classDef state fill:#ffe6cc,stroke:#d79b00,color:#17202a;
    linkStyle 0,5 stroke:#5f913f,stroke-width:2px
...
Creator (14378cu)
└─ VestingPositions::CloseCampaign ✓ 14378cu
...
flowchart LR
    ...
    Alicesreceipt[("Alice's receipt")]:::state
    Alice -->|signs| VestingPositions
    VestingPositions -->|writes| Alicesreceipt
    classDef program fill:#dae8fc,stroke:#6c8ebf,color:#17202a;
    classDef signer fill:#d5e8d4,stroke:#82b366,color:#17202a;
    classDef state fill:#ffe6cc,stroke:#d79b00,color:#17202a;
    linkStyle 0 stroke:#5f913f,stroke-width:2px
    linkStyle 1 stroke:#b87800,stroke-width:2px
```
