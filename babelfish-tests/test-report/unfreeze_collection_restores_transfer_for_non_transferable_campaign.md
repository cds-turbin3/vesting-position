...
**Source:** [`tests/freeze.rs` L97](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/freeze.rs#L97)
...
Alice (8836cu)
└─ mplCoreProgram::Transfer ✗ 8836cu
```

</details>

### T3: FreezeCollection (day 1)
...
Alice (8736cu)
└─ mplCoreProgram::Transfer ✓ 8736cu
```
