...
**Source:** [`tests/clawback.rs` L202](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/clawback.rs#L202)
...
| T1 | 10,000,000,000,000 |  | 0 |  | ClawbackUnclaimed (day 31) |
...
Creator (43127cu)
└─ VestingPositions::ClawbackUnclaimed ✗ 43127cu
   └─ system::createAccount ✓
```
