...
**Source:** [`tests/clawback.rs` L332](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/clawback.rs#L332)
...
*🟠 creatorAta(Creator, token, Mint) → campaignAta(Vesting campaign, token, Mint) · 🔵 campaignAta(Vesting campaign, token, Mint) → creatorAta(Creator, token, Mint)*
