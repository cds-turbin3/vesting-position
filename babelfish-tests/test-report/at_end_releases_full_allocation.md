...
**Source:** [`tests/vesting_schedule.rs` L99](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/vesting_schedule.rs#L99)
...
xychart-beta
    x-axis ["d0", "d31"]
    line [10000000000000, 9000000000000]
    line [0, 0]
```
...
xychart-beta
    ...
    line [0, -1000000000000]
    line [0, 0]
```

*🟠 Vault balance (-1T) · 🔵 Creator balance (0)*
...
flowchart LR
    ...
    linkStyle 1,2,3,4,5,7,10,13,17,18,20 stroke:#b87800,stroke-width:2px
```
