...
**Source:** [`tests/vesting_schedule.rs` L67](https://github.com/cds-turbin3/vesting-position/blob/0b610d8142f4f1ce80bcda3fc16e184a127166b5/babelfish-tests/tests/vesting_schedule.rs#L67)
...
| T1 | 9,450,000,000,000 | -550,000,000,000 | 0 |  | — | FirstClaim (day 16) |
...
xychart-beta
    x-axis ["d0", "d16"]
    line [10000000000000, 9450000000000]
    line [0, 0]
```
...
*🟠 Vault balance (-550B) · 🔵 Creator balance (0)*
...
*🟠 creatorAta(Creator, token, Mint) → campaignAta(Vesting campaign, token, Mint) · 🔵 campaignAta(Vesting campaign, token, Mint) → Alice/ATA(Mint)*
...
**Alice's balance:** `0` → `550,000,000,000` — mid-schedule claim: cliff slice + half the linear remainder
...
└─ VestingPositions::Claim ✓ 168120cu
