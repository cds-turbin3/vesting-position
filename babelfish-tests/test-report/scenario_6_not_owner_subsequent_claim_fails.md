...
**Source:** [`tests/claim.rs` L169](https://github.com/cds-turbin3/vesting-position/blob/28dc8ede57427d32d19572b56334ba5ee4d73e8b/babelfish-tests/tests/claim.rs#L169)
...
flowchart LR
    ...
    Collection[("Collection")]:::state
    campaignAtacampaignCollectionTokeMint[("campaignAta(campaign(Collection), Toke…, Mint)")]:::state
    userAta4wQQTokeMint(["userAta(4wQQ…, Toke…, Mint)"]):::signer
    n5fjL[("5fjL…")]:::state
    n5yfA(["5yfA…"]):::signer
    splAssociatedTokenAccount["splAssociatedTokenAccount"]:::program
    token["token"]:::program
    ...
    splAssociatedTokenAccount --> userAta4wQQTokeMint
    n4wQQ --> system
    userAta4wQQTokeMint --> system
